...
typedef struct particular_pokemon {
	char nombre[MAX_NOMBRE];
	int nivel;
	bool capturado; // pero si es booleano S y N no 
 ...
 */
pokedex_t* pokedex_crear(char entrenador[MAX_NOMBRE]);//hecho
 ...
 */
int pokedex_avistar(pokedex_t* pokedex, char ruta_archivo[MAX_RUTA]);//hecho
 ...
 */
int pokedex_evolucionar(pokedex_t* pokedex, char ruta_archivo[MAX_RUTA]);//hecho
 ...
 * vacía.
 */
void pokedex_ultimos_capturados(pokedex_t* pokedex);//hecho
 ...
 * vacía.
 */
void pokedex_ultimos_vistos(pokedex_t* pokedex);//hecho
 ...
 *
 */
void pokedex_informacion(pokedex_t* pokedex, int numero_pokemon, char nombre_pokemon[MAX_NOMBRE]);//hecho
