 ...
 * crearlo.
 */
hash_t* hash_crear(hash_destruir_dato_t destruir_elemento, size_t capacidad);//ya está
 ...
 */
int hash_insertar(hash_t* hash, const char* clave, void* elemento);//ya está
 ...
 * hash.
 */
void hash_destruir(hash_t* hash);//ya está
